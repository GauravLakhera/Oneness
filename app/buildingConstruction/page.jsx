...
export default function BuildingConstruction() {
  ...
  return (
    <div className="relative min-h-screen bg-white text-black/80 pt-32">
      ...
      <section className="py-8 lg:py-24 section-padding">
        <div className="max-w-7xl mx-auto">
          <div className="page-hero">
            <p className="lg:text-6xl text-4xl mb-12">Building & Construction/</p>
            <div className="max-w-3xl ml-auto">
              <p className="text-3xl font-sentient leading-relaxed">
                ONENESS offer comprehensive building and construction services, delivering 
                high-quality structures that meet the functional, aesthetic, and safety 
                requirements of our clients. From groundwork to final finishes, our expertise 
                spans across commercial, industrial, institutional, and residential projects.
              </p>
            </div>
          </div>
        </div>
      ...
      {/* Mission Statement */}
      <img src="https://cdn.pixabay.com/photo/2019/12/10/20/59/site-4686908_1280.jpg" className="grayscale w-full h-[28rem] object-cover object-center" alt="Construction site" />
          ...
          <div className="grid md:grid-cols-1 py-10 gap-20 bg-[#dcdbd0]">
            <FadeInSection>
              ...
              <AnimatedText
                ...
                splitType="words"
              >
                We work closely with clients to navigate complex legal and commercial 
                challenges amid the real-world pressures of construction delivery. Our 
                approach is practical, proactive, and focused on achieving strategic outcomes.
              </AnimatedText>
            </FadeInSection>
          </div>
        </div>
      ...
      <section className="pt-32 pb-10  section-padding bg-black/90 text-white/80">
        <div className="flex justify-between flex-col-reverse lg:flex-row gap-6">
          <h1 className="text-3xl lg:w-8/12">
            Our team has been engaged in significant dispute resolution and advisory roles 
            across a range of projects, including residential towers, public infrastructure 
            precincts, nationwide rollout programs, and large-scale commercial developments.
          </h1>
        ...
        <div className="flex flex-col justify-start items-start  text-start mt-10">
          <div className="lg:w-10/12">
            <p className="text-lg text-white/70 mb-6">
              We represent clients in high-stakes litigation under the Home Building Act, 
              the Design and Building Practitioners Act, and the Residential Apartment Buildings Act.
            </p>
            <ul className="text-sm font-extralight text-white/80 space-y-2">
              <li>
                <strong>Dispute Resolution</strong> - Supreme Court proceedings and complex mediations
              </li>
              <li>
                <strong>Claims Management</strong> - Delay, disruption, defective works, and variations
              </li>
              <li>
                <strong>Legal Compliance</strong> - Security of Payment adjudications and arbitration
              </li>
              <li>
                <strong>Advisory Services</strong> - Proactive legal strategy and risk management
              </li>
            </ul>
          </div>
        </div>
      ...
      <section className="py-20 section-padding bg-[#dcdbd0]">
        <div className="max-w-7xl mx-auto">
          <h2 className="text-5xl mb-16 text-center font-sentient">Our Project Expertise/</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              { 
                ...
                icon: <MdFoundation/>,
                description: "Complete structural solutions from foundation to superstructure",
                details: ["RCC foundations & footings", "Columns, beams & slabs", "Brick/block masonry works", "Structural steel frameworks"]
              },
              { 
                title: "Superstructure & Finishing", 
                icon: <FaPaintRoller/>,
                description: "High-quality finishing works for aesthetic and functional excellence",
                details: ["Plastering & wall finishes", "Flooring & tiling works", "Painting & texture coating", "Doors, windows & fittings"]
              },
              { 
                title: "Industrial & Pre-Engineered Buildings", 
                icon: <FaWarehouse/>,
                description: "Specialized construction for industrial and commercial facilities",
                details: ["Factory sheds & warehouses", "Steel structure fabrication", "Pre-engineered buildings", "Industrial flooring systems"]
              },
              { 
                title: "External Development", 
                icon: <FaTree/>,
                description: "Complete site development and external infrastructure works",
                details: ["Compound walls & fencing", "Drainage & stormwater systems", "Paving & road construction", "Landscaping & site grading"]
              },
              { 
                title: "Renovation & Expansion", 
                icon: <FaTools/>,
                description: "Modification and upgradation of existing structures",
                details: ["Building extensions", "Structural modifications", "Interior renovations", "Heritage restoration works"]
              },
              { 
                title: "Project Management & QC", 
                icon: <FaClipboardCheck/>,
                description: "End-to-end project coordination with quality assurance",
                details: ["Project planning & scheduling", "Material management", "Safety compliance", "Quality control & timely delivery"]
              }
            ].map((item, index) => (
      ...
      <div className="bg-[#33312f]">
        <section className="flex container mt-16 w-7xl mx-auto lg:mt-0 flex-col lg:flex-row min-h-screen text-[#efe0b1] justify-between items-start px-8 py-16 gap-8">
          <div className="flex flex-col gap-10 lg:max-w-[50%]">
            ...
            <h3 className="text-3xl font-sentient mb-4">Construction Excellence/</h3>
            <p className="text-white/80 text-base md:max-w-xl leading-relaxed font-sentient">
              Our construction expertise combines traditional craftsmanship with modern 
              technology, ensuring every project meets the highest standards of quality, 
