...
const InsightsArticles = () => {
  ...
  return (
    <section className="bg-black/80 py-12 px-4 md:px-10 text-white/90">
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row gap-8">
        {/* Sidebar */}
        <aside className="w-full md:w-1/4 space-y-10 border-r border-white">
          <h2 className="text-4xl font-[300] mb-4 hidden md:block">
            Categories
          </h2>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
            {visibleArticles.map((article, index) => (
              ...
              >
                ...
                <button className="border flex gap-2 items-center border-white px-8 py-3 mt-5 hover:bg-black hover:text-white/90 hover:border-black transition-all duration-300">
