    ...
    <div className="relative pt-[160px] md:pt-[80px] pb-[150px]">
      ...
      <div className="max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-10 flex flex-col md:flex-row items-center gap-10 md:gap-20">
        ...
        <div className="md:w-[30%] w-full">
          <p className="text-5xl md:text-7xl font-sans font-[400] text-black/90 text-start md:text-left">
            Our People/
          </p>
        </div>
        ...
        <div className="md:w-[60%] md:mt-[180px] w-full">
          <AnimatedText className="text-3xl font-sentient md:text-4xl lg:text-5xl font-[300] leading-snug text-black/90 text-start md:text-left">
            Oneness solution-driven outlook is the product of an innovative and
            supportive culture.
          </AnimatedText>
          <AnimatedText className="text-lg mt-8 md:text-lg  font-[300] leading-snug text-black/90 text-start md:text-left">
